...
#pragma HLS PIPELINE II=3
 ...
 TRI_diff_t dx1 = x2 - x1, dy1 = test_y - y1, dy2 = y2 - y1, dx2 = test_x - x1;
    ...
    bool x_ok = (ix >= 0) && (ix <= 384);
    bool x_plus_ok = (ix <= 384 - 1);

    bool y_minus_ok = (iy >= 1);
    bool y_ok = (iy >= 0) && (iy <= 384);
    bool y_plus_ok = (iy <= 384 - 1);
    bound=x_ok&y_ok;
