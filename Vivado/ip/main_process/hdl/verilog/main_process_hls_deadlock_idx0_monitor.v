...
assign sub_parallel_block = 1'b0 | ((idx3_block & (axis_block_sigs[3])) & ((idx4_block | inst_idle_sigs[4]))) | ((idx4_block & (axis_block_sigs[4])) & ((idx3_block | inst_idle_sigs[3])));
assign all_sub_parallel_has_block = sub_parallel_block;
assign all_sub_single_has_block = 1'b0 | (idx1_block & (axis_block_sigs[1])) | (idx2_block & (axis_block_sigs[2])) | (idx5_block & (axis_block_sigs[5])) | (idx6_block & (axis_block_sigs[6])) | (idx7_block & (axis_block_sigs[7])) | (idx8_block & (axis_block_sigs[8])) | (idx9_block & (axis_block_sigs[9]));
