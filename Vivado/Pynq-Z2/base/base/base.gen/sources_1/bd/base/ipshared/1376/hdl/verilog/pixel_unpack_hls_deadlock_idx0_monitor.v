...
assign sub_parallel_block[0] = 1'b0 | ((idx1_block & (axis_block_sigs[0] | axis_block_sigs[1])) & ((idx2_block | inst_idle_sigs[2]) & (idx3_block | inst_idle_sigs[3]))) | ((idx2_block & (axis_block_sigs[2] | axis_block_sigs[3])) & ((idx1_block | inst_idle_sigs[1]) & (idx3_block | inst_idle_sigs[3]))) | ((idx3_block & (axis_block_sigs[4] | axis_block_sigs[5])) & ((idx1_block | inst_idle_sigs[1]) & (idx2_block | inst_idle_sigs[2])));
assign sub_parallel_block[1] = 1'b0 | ((idx4_block & (axis_block_sigs[6] | axis_block_sigs[7])) & ((idx5_block | inst_idle_sigs[5]))) | ((idx5_block & (axis_block_sigs[8] | axis_block_sigs[9])) & ((idx4_block | inst_idle_sigs[4])));
