...
assign all_sub_single_has_block = 1'b0 | (idx1_block & (axis_block_sigs[0])) | (idx2_block & (axis_block_sigs[1])) | (idx5_block & (axis_block_sigs[4])) | (idx6_block & (axis_block_sigs[5])) | (idx7_block & (axis_block_sigs[6])) | (idx8_block & (axis_block_sigs[7])) | (idx9_block & (axis_block_sigs[8]));
