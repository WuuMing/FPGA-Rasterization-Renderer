...
design_libs=(xilinx_vip xpm xbip_utils_v3_0_13 axi_utils_v2_0_9 xbip_pipe_v3_0_9 xbip_dsp48_wrapper_v3_0_6 xbip_dsp48_addsub_v3_0_9 xbip_dsp48_multadd_v3_0_9 xbip_bram18k_v3_0_9 mult_gen_v12_0_21 floating_point_v7_1_18 xil_defaultlib)
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../ipstatic/hdl/verilog" +incdir+"../../../../base.gen/sources_1/ip/main_process_0_3/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../ipstatic/hdl/verilog" +incdir+"../../../../base.gen/sources_1/ip/main_process_0_3/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work floating_point_v7_1_18 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl/verilog" +incdir+"../../../../base.gen/sources_1/ip/main_process_0_3/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/floating_point_v7_1_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl/verilog" +incdir+"../../../../base.gen/sources_1/ip/main_process_0_3/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.main_process_0 xil_defaultlib.glbl -o main_process_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./main_process_0_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key main_process_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc main_process_0_simv.daidir vcs_lib c.obj)
