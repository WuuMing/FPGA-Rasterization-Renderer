...
HD_PWD='/home/wu/__PYNQ__/board_grey/Pynq-Z2/base/base/base.runs/main_process_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_process_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_process_0.tcl
