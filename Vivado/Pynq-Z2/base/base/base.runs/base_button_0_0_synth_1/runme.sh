...
HD_PWD='/home/wu/__PYNQ__/board_grey/Pynq-Z2/base/base/base.runs/base_button_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_button_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_button_0_0.tcl
