...
HD_PWD='/home/wu/__PYNQ__/boards/Pynq-Z2/base/base/base.runs/base_ila_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_ila_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_ila_1_0.tcl
